...
export default function JogoDoBichoScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button mode="contained" onPress={gerarAnimal} style={styles.botao}>Gerar Animal</Button>
      {animalGerado && (
        <Card style={styles.card}>
          <Card.Content>
            <Title style={styles.titulo}>Nº {animalGerado.numero} - {animalGerado.nome}</Title>
...
const styles = StyleSheet.create({
  ...
  botao: { backgroundColor: '#0077b6', marginBottom: 16 },
  card: { backgroundColor: '#3a3a3a', marginTop: 16, alignItems: 'center' },
  titulo: { fontSize: 22, color: '#9a9a9a', marginBottom: 10 },
  imagem: { width: 200, height: 200, borderRadius: 12 },
});